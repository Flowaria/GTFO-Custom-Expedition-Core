...
namespace CustomExpeditions.CustomReplicators
{
    public static class CustomReplicatorManager
    {
        ...
        public static void RegisterReplicator(IReplicator replicator, string guid, Action<pDoorState, pDoorState, bool> onStateChanged)
        {
            ...
            switch(replicator.Type)
            {
                case SNet_ReplicatorType.Manager:
                    Replicators.Add(_ManagerIDBuffer++, info);
                    break;

                case SNet_ReplicatorType.SelfManaged:
                    Replicators.Add(_ManagedIDBuffer++, info);
                    break;
            }
        }
        ...
        public static bool InvokeStateChange(string guid, pDoorState oldState, pDoorState newState, bool recall)
        {
            try
            {
